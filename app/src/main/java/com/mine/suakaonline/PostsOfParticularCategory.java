...
import com.mine.suakaonline.helper.CommonAdapter;
import com.mine.suakaonline.helper.DateConverter;
import com.mine.suakaonline.helper.Font;
import com.mine.suakaonline.helper.SingletonVolley;
import com.mine.suakaonline.model.JsonDataModel;
...
//        font.setFont(getApplicationContext(), toolBarTextView);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra(POST_DATE,dateConverter.getDate(JsonCategoriesDatas.get(position).getDate())+" "+ dateConverter.getMonth(JsonCategoriesDatas.get(position).getDate())+" "+ dateConverter.getYear(JsonCategoriesDatas.get(position).getDate()));
