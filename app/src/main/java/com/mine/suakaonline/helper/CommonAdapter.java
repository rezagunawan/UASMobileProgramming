...
public class CommonAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.date.setText(dateConverter.getDate(jsonData.get(position).getDate())+" "+ dateConverter.getMonth(jsonData.get(position).getDate())+" "+ dateConverter.getYear(jsonData.get(position).getDate()));
