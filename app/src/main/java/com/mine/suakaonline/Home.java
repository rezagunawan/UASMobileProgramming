...
//                break;
            case R.id.nav_about_us:
                ...
                intent.putExtra(PAGE_TITLE,"Tentang Suaka");
                intent.putExtra(PAGE_URL, Const.pages.replace("PAGE_ID","1103"));
            ...
            case R.id.nav_website:
                startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("http://www.suakaonline.com")));
                break;
            case R.id.nav_website_fresh:
                startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("http://www.fresh.suakaonline.com")));
                break;
            case R.id.nav_website_lensa:
                startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("http://www.lensa.suakaonline.com")));
                break;
        }
    ...
    public static Intent openFacebook(Context context){
        try {
            ...
            return new Intent(Intent.ACTION_VIEW, Uri.parse("fb://page/185572468143429"));
        } catch (Exception e){
            return new Intent(Intent.ACTION_VIEW,Uri.parse("https://web.facebook.com/officiallpmsuaka/"));
        }
    }
    ...
    public static Intent openYoutube(Context context){
        try {
            ...
            return new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/user/Suakanews"));
        } catch (Exception e){
            return new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.youtube.com/user/Suakanews"));
        }
    }
